...
class DataIngestionConfig:
    ...
    def __init__(self, training_pipeline_config:TrainingPipelineConfig):
        ...
        self.train_file_path:Path = Path(training_pipeline_config.artifacts_folder)/training_pipeline_config.data_ingestion_dir_name/training_pipeline_config.train_file_name
        self.test_file_path:Path = Path(training_pipeline_config.artifacts_folder)/training_pipeline_config.data_ingestion_dir_name/training_pipeline_config.test_file_name
